...
class SpringRotate extends StatefulWidget {
  final GlobalKey<SpringRotateState> key;
  final Motion motion;
  final double begin;
  final double end;
  ...
  @override
  SpringRotateState createState() => SpringRotateState();
}

class SpringRotateState extends State<SpringRotate> {
  ...
  Widget build(BuildContext context) {
    final _tween = MultiTrackTween([
      Track("rotation").add(widget.animDuration, ConstantTween(0.0)).add(
          widget.animDuration,
          Tween(begin: pi / widget.begin, end: pi / widget.end),
          curve: widget.curve)
    ]);
